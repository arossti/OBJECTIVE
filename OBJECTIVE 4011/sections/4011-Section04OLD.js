...
window.TEUI.SectionModules.sect04 = (function () {
  ...
  function updateElectricityEmissionFactor() {
    ...
    if (window.TEUI?.StateManager) {
      ...
      console.warn(
        "[S04] StateManager not available for updateElectricityEmissionFactor.",
      );
