...
TEUI.ReferenceManager = (function () {
  ...
  function initialize() {
    ...
    TEUI.StateManager.addListener("d_13", function (newValue) {
      ...
      console.log(
        `[ReferenceManager] d_13 changed to: ${newValue}. activeReferenceDataSet will be updated by StateManager or ReferenceToggle.`,
      );
      ...
      if (
        ...
        console.log(
          "[ReferenceManager] In Reference Mode, d_13 changed. Triggering UI refresh via ReferenceToggle.",
        );
        setTimeout(() => {
