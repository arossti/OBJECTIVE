...
A50=15.11, from =E64, where E64= E60 - (E60 - (E60 - (100 - E59)/5)) * (0.1 + 0.9 * (E59 / 100))
*   Terms: 
    *   E60=A3 (Night-Time Temp, 20.43)
    *   E59=A4*100 (Avg RH % = 55.85)

A56=1,713.91, from formula =610.94 * EXP(17.625 * A50 / (A50 + 243.04)), where A50 is defined above. 

A58=1199.74, from =A56*A57, where A56 is defined above and A57=70% (hard coded), Outdoor Seasonal Relative Humidity %

A59=610.94 * EXP(17.625 * A8 / (A8 + 243.04)), the Pa Saturation Vapor Pressure at Indoor Conditions
*   Terms:
