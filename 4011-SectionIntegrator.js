...
TEUI.SectionIntegrator = (function() {
    ...
    function registerTEUIIntegration() {
        ...
        registeredIntegrations.teui = {
            ...
            description: 'Calculates TEUI values in Section01 based on energy data from Section04',
    ...
    function registerEmissionsFactorIntegration() {
        ...
        registeredIntegrations.emissionsFactor = {
            ...
            description: 'Updates emission factors in Section04 based on province selection in Section03',
    ...
    function registerRadiantGainsIntegration() {
        ...
        registeredIntegrations.radiantGains = {
            ...
            description: 'Calculates solar gains based on building orientation and climate data',
    ...
    function registerTEDITELIIntegration() {
        ...
        registeredIntegrations.tediTeli = {
            ...
            description: 'Integrates TEDI/TELI calculations with building area and TEUI summary',
    ...
    function registerVolumeMetricsIntegration() {
        ...
        registeredIntegrations.volumeMetrics = {
            ...
            description: 'Integrates building volume metrics with envelope and TEDI/TELI calculations',
    ...
    function forceTEDITELIUpdate() {
        ...
        if (window.TEUI.SectionModules && window.TEUI.SectionModules.sect15) {
            if (typeof window.TEUI.SectionModules.sect15.calculateAll === 'function') {
                ...
                if (typeof window.TEUI.SectionModules.sect15.updateDisplay === 'function') {
    ...
    function setupSection04Listeners() {
        ...
        const actualEnergyInputs = section04.querySelectorAll('input[data-contributes-to="f_32"]');
        ...
        if (dropdown) {
            dropdown.addEventListener('change', function() {
                ...
                if (window.TEUI.SectionModules.sect01 && 
                    typeof window.TEUI.SectionModules.sect01.updateActualValuesBasedOnDropdown === 'function') {
    ...
    function setupVolumeMetricsListeners() {
        ...
        const envelopeFields = ['h_85', 'h_86', 'h_89', 'h_95', 'd_85', 'd_86', 'd_89', 'd_90', 'd_91', 'd_92', 'd_95'];
