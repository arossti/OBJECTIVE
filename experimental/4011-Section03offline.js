...
window.TEUI.SectionModules.sect03 = (function () {
  ...
  function updateWeatherData() {
    ...
    console.log(
      `[Debug Section 3] Fetched hddValue for ${cityValue}:`,
      hddValue,
    );
    ...
    const sectionHeaderForWeather = document.querySelector(
    ...
    const coldestTemp =
      coldestTempSource ||
      (isFuture ? cityData.January_1_2021_2050 : cityData.January_1) ||
      (isFuture ? cityData.January_2_5_2021_2050 : cityData.January_2_5) ||
      "-26";
