...
**Fix Strategy:**
- NOT a calculation bug - all math is correct
- Minor refinement: Ensure g_118 dropdown change triggers full calculation cascade
- Relates to SEPT15-RACE-MITIGATION.md discussion of listener propagation
- Low priority - "Cooling Bump" workaround is effective and users understand it
