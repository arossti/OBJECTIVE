...
window.TEUI.diag.checkRHState = function() {
    ...
    if (referenceValue === null || referenceValue === undefined) {
        console.warn("⚠️ WARNING: 'ref_i_59' is not present in the StateManager. This indicates a PUBLICATION failure in 4012-Section08.js.");
    } else {
...
window.TEUI.diag.checkCoolingState = function() {
    ...
    console.log("---------------------------------");
    console.log("To test, change the i_59 slider in Reference mode and run this check again. If 'Internal Indoor RH' does not update, it indicates a LISTENING failure in 4012-Cooling.js.");
};

console.log("✅ RH-DEBUG-SCRIPT.js loaded. Use `TEUI.diag.checkRHState()` and `TEUI.diag.checkCoolingState()` to debug.");
