...
(function() {
    ...
    function calculateGroundFacingCDD(inputs) {
        ...
        return {
            target: calc(inputs.target?.h_24, inputs.target?.m_19, inputs.target?.h_21),
            reference: calc(inputs.reference?.h_24, inputs.reference?.m_19, inputs.reference?.h_21)
        };
    }
    ...
    function getClimateData(province, city, timeframe) {
        ...
        return {
            hdd: isFuture ? (cityData.HDD18_2021_2050 || cityData.HDD18 || 4600) : (cityData.HDD18 || 4600),
            cdd: isFuture ? (cityData.CDD24_2021_2050 || cityData.CDD24 || 196) : (cityData.CDD24 || 196),
            coldestTemp: cityData.January_2_5 || -24,
            hottestTemp: isFuture ? (cityData.Future_July_2_5_Tdb || cityData.July_2_5_Tdb || 30) : (cityData.July_2_5_Tdb || 30),
