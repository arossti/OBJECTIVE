...
function setupSection11(stateManager) {
    ...
    stateManager.registerCalculation('wallHeatLoss', {
        inputs: ['d_85', 'd_86', 'd_87', 'd_88', 'f_85', 'f_86', 'f_87', 'f_88', 'hdd'],
        ...
        calculate: (inputs) => {
            ...
            const result = {
                ...
                reference: { i_85: 1500, i_86: 2250, i_87: 0, i_88: 0, wallTotal: 3750 }
            };
            return result;
        }
    });
    ...
    stateManager.registerCalculation('windowHeatLoss', {
        inputs: ['d_89', 'd_90', 'd_91', 'd_92', 'f_89', 'f_90', 'f_91', 'f_92', 'hdd'],
        ...
        calculate: (inputs) => {
            ...
            const result = {
                ...
                reference: { i_89: 2857, i_90: 3429, i_91: 0, i_92: 0, windowTotal: 6286 }
            };
            return result;
        }
    });
    ...
    stateManager.registerCalculation('totalEnvelopeLoss', {
        ...
        outputs: ['i_104'],
        description: 'Calculate total envelope transmission loss with thermal bridge penalty',
        calculate: (inputs) => {
            const wallTotal = {
            ...
            const tbPenalty = {
                target: parseFloat(inputs.target.d_97) || 0.10,
                reference: parseFloat(inputs.reference.d_97) || 0.10
            };
            
            return {
                target: {
                    i_104: (wallTotal.target + windowTotal.target) * (1 + tbPenalty.target)
                },
                reference: {
                    i_104: (wallTotal.reference + windowTotal.reference) * (1 + tbPenalty.reference)
                }
            };
        }
    });
