const VALIDATION_TOOLTIPS = {
  ...
  d_16: {
    ...
    title: "S4. Targets",
    message:
      "IPCC AR6 EPC = Equal PerCapita method to limit to 1.5\u00baC_x000a_IPCC AR6 EA = Equity-Adjusted method to limit to 1.5\u00baC_x000a_(refer to Worksheet S.3 Carbon Standards)",
  },
  d_19: {
    cell: "D19",
  ...
  d_25: {
    ...
    message:
      "ASHRAE may permit 26\u00baC, where NBC 2025 may require 24\u00baC. Residents will often set lower. Use 24\u00baC as Default for design. ",
  },
  d_27: {
    cell: "D27",
    title: "Electricity",
  ...
  i_21: {
    ...
    message:
      "Fakes a value (0-50% max.) for ground-facing elements, that absorb some excess thermal energy. Cooling season is short in Canada and mass-y elements eventually reach equilibrium/steady-state. Enter 0% when subgrade elements are not part of conditioned vol",
  },
  i_41: {
    cell: "I41",
  ...
  l_20: {
    ...
    message:
      "Night-Time Temp Outside in \u00baC (\u2248 Summer Mean Jun-Aug) USER DEFINED or from Weather File",
  },
  l_21: {
    cell: "L21",
  ...
  // Unmapped cells (no field_id mapping yet):
  E14: {
    cell: "E14",
    title: "Select a Method",
    message:
