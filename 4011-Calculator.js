...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (window.TEUI.StateManager) {
        ...
        // DISABLED: This wildcard listener was causing infinite recursion loops
        // It violates the V2 "traffic cop" pattern by having every field change
        // trigger a global recalculation instead of targeted dependency updates
        // The StateManager's dependency system and section-specific listeners 
        // should handle recalculation coordination instead
