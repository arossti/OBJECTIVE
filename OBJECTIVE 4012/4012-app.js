...
(function () {
  ...
  const AppState = {
    ...
    sections: [
      ...
      {
        id: "actualTargetEnergy",
        name: "Actual vs. Target Energy",
        shortName: "Target",
        icon: "bi-bullseye",
      },
      {
      ...
      {
        id: "occupantInternalGains",
        name: "Occupant + Internal Gains",
        shortName: "Internal G",
        icon: "bi-cup-hot",
      },
      {
        id: "envelopeRadiantGains",
        name: "Radiant Gains",
        shortName: "Envelope G",
        icon: "bi-box-arrow-in-down-right",
      },
      {
        id: "envelopeTransmissionLosses",
        name: "Transmission Losses",
        shortName: "Trans",
        icon: "bi-box-arrow-up-right",
      },
      {
        id: "volumeSurfaceMetrics",
        name: "Volume and Surface Metrics",
        shortName: "Vol",
        icon: "bi-box",
      },
      {
        id: "mechanicalLoads",
        name: "Mechanical Loads",
        shortName: "Mech",
        icon: "bi-house-gear",
      },
      {
  ...
  const UIController = {
    ...
    toggleLayout: function () {
      AppState.currentLayout =
        AppState.currentLayout === "vertical" ? "horizontal" : "vertical";
      this.updateLayoutClasses();
      ...
      if (tabContainer) {
        tabContainer.style.display =
          AppState.currentLayout === "horizontal" ? "flex" : "none";
      }
    ...
    showSection: function (sectionId) {
      document
        .querySelectorAll(".section:not(#keyValues)")
        .forEach((section) => {
    ...
    toggleReferenceMode: function () {
      ...
      this.updateFeedback(
        document.body.classList.contains("reference-mode")
