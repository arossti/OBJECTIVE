            ...
            cells: {
              ...
              d: {
                ...
                options: [
                  ...
                  {
                    value: "B2-Care and Treatment",
                    name: "B2-Care and Treatment",
                  },
                  {
    ...
    setupEventHandlers: function () {
      ...
      section.addEventListener("input", (e) => {
        if (e.target.matches('input[type="range"]')) {
          ...
          // Update display
          const valueDisplay =
            e.target.parentElement.querySelector(".slider-value");
          if (valueDisplay) {
