...
This possibility remained hidden because Cartesian coordinates, with their symmetric $\pm$ axes, made the question structurally unaskable. Only by adopting a coordinate system where all of 3D space can be described with non-negative values does the deeper question emerge: what is a \emph{negative} position?
